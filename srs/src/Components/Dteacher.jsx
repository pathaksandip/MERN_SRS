...
import Dstudent from "./Pages/Dstudent";
import Dclass from "./Pages/Dclass";
import Dsubject from "./Pages/Dsubject";
import Dexam from "./Pages/Dexam";
